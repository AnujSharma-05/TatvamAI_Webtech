...
const StyledSelect = React.forwardRef<HTMLSelectElement, any>(
  ({ children, ...props }, ref) => (
    <select
      ref={ref}
      {...props}
      className="w-full px-4 py-3 bg-transparent border rounded-xl appearance-none focus:outline-none focus:ring-2"
      style={
        {
          borderColor: `${COLORS.cadetGray}30`,
          color: COLORS.nyanza,
...
export default function SignUpPage() {
  ...
  const handleSendPhoneOtp = async () => {
    ...
    try {
      await axios.post("/users/send-phone-otp-register", {
  ...
  const handleVerifyPhoneOtp = async () => {
    ...
    try {
      await axios.post("/users/verify-phone-otp", {
        phoneNo: formData.phone,
        otp: phoneOtp,
      });
  ...
  const handleSendEmailOtp = async () => {
    ...
    try {
      await axios.post("/users/send-verification-code", {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const registrationData = {
        ...restData,
        phoneNo: phone,
        knownLanguages: formData.knownLanguages.join(","),
      };
      ...
      if (response.data.data.accessToken && response.data.data.refreshToken) {
        ...
        // Redirect to Dhvani Shilp page
        navigate("/dhvani-shilp");
      } else {
      ...
      >
        ...
        >
          <div className="text-center mb-8">
            ...
            >
              Join <span style={{ color: COLORS.teaGreen }}>TatvamAI</span>
            </h1>
          ...
          <div className="flex justify-center items-center mb-8">
            <div
              ...
              style={{
                background:
                  step >= 1 ? COLORS.teaGreen : `${COLORS.midnightGreen}40`,
                color: step >= 1 ? COLORS.midnightGreen : COLORS.cadetGray,
              }}
            >
              1
            </div>
            <div
              ...
              style={{
                background:
                  step >= 2 ? COLORS.teaGreen : `${COLORS.midnightGreen}40`,
              }}
            />
            <div
              className="flex items-center justify-center w-8 h-8 rounded-full font-bold"
              style={{
                background:
                  step >= 2 ? COLORS.teaGreen : `${COLORS.midnightGreen}40`,
                color: step >= 2 ? COLORS.midnightGreen : COLORS.cadetGray,
              }}
            >
              2
            </div>
          ...
          {step === 1 ? (
            <form onSubmit={handleNext} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="relative">
                  ...
                  >
                    <EyeOff size={20} style={{ color: COLORS.cadetGray }} />
                  </button>
                </div>
                <div className="relative">
                  <StyledInput
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 pr-4 flex items-center"
                  >
                    <Eye size={20} style={{ color: COLORS.cadetGray }} />
                  </button>
                </div>
              </div>
              <button
                ...
                style={{
                  ...
                  opacity: isCheckingExistence ? 0.7 : 1,
                }}
              >
            ...
            <div className="space-y-6">
              <div
                ...
                style={{ background: `${COLORS.midnightGreen}20` }}
              >
                <h3
                    ...
                    <label key={lang} className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            knownLanguages: e.target.checked
                        ...
                        className="rounded bg-transparent border-2"
                        style={{
                          borderColor: `${COLORS.cadetGray}40`,
                          accentColor: COLORS.teaGreen,
                        }}
                      />
                      {lang}
                    </label>
              ...
              <div className="flex gap-4 pt-4">
                <button
                  ...
                  style={{
                    background: `${COLORS.cadetGray}20`,
                    color: COLORS.nyanza,
                  }}
                >
                  Back
